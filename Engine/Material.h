...
class Shader;  //어떤 쉐이더와 연결이 되어있는지 알기위해 필요
class Texture;
...
struct MaterialParams
{
	...
	array<int32, MATERIAL_ARG_COUNT> intParams;  //std array  c배열을 매핑한 클래스
...
public:
	...
	void Dispatch(uint32 x, uint32 y, uint32 z);  //실질적으로 comput shader실행하는 부분
